...
<body>
    ...
    <div class="alert alert-danger alert-dismissible fade show mb-5" role="alert">
    <span class="alert-inner--icon"><i class="fa fa-bolt"></i></span>
    <span class="alert-inner--text"><strong>Oops!</strong> Something went wrong!</span>
    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
        <span aria-hidden="true">&times;</span>
    </button>
</div>
...
<% }}
		...
		<div id="myCarousel" class="carousel slide" data-ride="carousel">
			...
			<div class="carousel-inner">
				<div class="item active">
					<img src="images/slider-img1.jpg" alt="Image1" style="width: 100%;"
						class="img-responsive ">
				</div>

				<div class="item">
					<img src="images/slider-img2.jpg" alt="Image2"
						style="width: 100% !important;">
				</div>

				<div class="item">
					<img src="images/slider-img-3.jpg" alt="Image3"
						style="width: 100% !important;">
				</div>
			</div>
	...
	<div class="features py-5" id="features">
			...
			<div class="title-section text-center mb-md-5 mb-4">
				<div class="w3ls-title-sub">Features</div>
				...
				<div class="row">
					<div class="col-lg-4 col-md-6 col-sm-6 mb-5">
						<div class="bottom-gd">
							...
							<div class="mt-2">Helps you connect with groups of
					...
					<div class="col-lg-4 col-md-6 col-sm-6 mb-5">
						<div class="bottom-gd">
							...
							<div class="mt-2">Meet new people, get out of their comfort
					...
					<div class="col-lg-4 col-md-6 col-sm-6 mb-5">
						<div class="bottom-gd">
							...
							<div class="mt-2">Simplifies the process of helping you find
					...
					<div class="col-lg-4 col-md-6 col-sm-6 mb-5">
						<div class="bottom-gd">
							...
							<div class="mt-2">Helps with mental ability and physical
								healthiness which is good sign for long run.</div>
						</div>
					</div>
					<div class="col-lg-4 col-md-6 col-sm-6  mb-5">
						<div class="bottom-gd">
							...
							<div class="mt-2">Friendly & Professional Team for the best
								customer support experience.</div>
						</div>
					</div>
					<div class="col-lg-4 col-md-6 col-sm-6 mb-5">
						<div class="bottom-gd">
							...
							<div class="mt-2">Boost your own journey of self-confidence
										and development.</div>
	...
	<div class="container py-xl-5 py-3">
		<div class="row pb-lg-4 pt-lg-5">
			<div class="col-lg-6 col-md-9 text-center">
				...
				<div class="mb-xl-5 mb-4">Free Delivery on your first order!</div>
