<%-- 
    Document   : eventcreate
    Created on : Nov 22, 2019, 10:22:11 PM
    Author     : Admin
--%>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-xs-12 col-md-12">
                    <input type="Number" name="cmob1" class="form-control">
              ...
              <label>Alternate Number:</label>
                <div class="row">
                <div class="col-xs-12 col-md-12">
                    <input type="Number" name="cmob2" class="form-control">
      ...
      <div class="row">
        <div class="col-md-12">
            ...
            <input class="form-control" name="etitle" placeholder="Event Title" type="text" />
            <textarea name="edesc" id="message" class="form-control" rows="6" cols="25" required="required" placeholder="Description"></textarea>
            <label for="">
                Starting Date:</label>
            <div class="row">
                <div class="col-xs-12 col-md-12">
                    <input class="form-control" type="date" name="estartdate">
                </div>
            ...
            <div class="row">
                <div class="col-xs-12 col-md-12">
                    <input class="form-control" type="date" name="eenddate">
                </div>
               
            </div>

             <label for="">
                Last Date for Registration:</label>
            <div class="row">
                <div class="col-xs-12 col-md-12">
                    <input class="form-control" type="date" name="elastdate">
                </div>
            ...
            <div class="row">
                <div class="col-xs-12 col-md-12">
                    <input type="Website" name="ewebsite" class="form-control">
