<%-- 
    Document   : showevent
    Created on : Dec 9, 2019, 3:06:59 PM
    Author     : harshit
--%>
				...
				<ul class="event-list">	
					...
					<li>
						<time datetime="2014-07-31 1600">
							<span class="day"><%=ev.getEventstartdate().getDate()%></span>
                                                        <span class="month"><%=ev.getEventstartdate()%></span>
							<span class="year">2017</span>
							<span class="time">13:57</span>
						</time>
						<img alt="Duyar Kimya Ziyaret" src="" />
						<div class="info">
                                                    <h2 class="title"><%=ev.getEventtitle()%></h2>
